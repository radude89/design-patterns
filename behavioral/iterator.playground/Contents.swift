...
/// # Iterator
///
/// - Description: provide a way to access the elements of an
...
///     because each iterator object contains its own iteration state.
///     - for the same reason, you can delay an iteration and
...
///     different aggregate structures (that is,
///     to support polymorphic iteration).
///     - 🥠 Use the Iterator pattern when your collection
///     has a complex data structure under the hood, but you
///     want to hide its complexity from clients
///     (either for convenience or security reasons).
///     - 🍥 Use the pattern to reduce duplication of
///     the traversal code across your app.
///     - 🍦 Use the Iterator when you want your code to be
///     able to traverse different data structures or when
