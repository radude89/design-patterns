...
/// # Strategy
///
/// - Description: define a family of algorithms, encapsulate each one, and make
...
///     - You can isolate the implementation details of an
///     algorithm from the code that uses it.
///
/// ## Disadvantages:
...
///     - ☔️ Use the Strategy when you have a lot of similar classes
///     that only differ in the way they execute some behavior.
///     - 🥭 Use the pattern to isolate the business logic of a class
///     from the implementation details of algorithms that may
///     not be as important in the context of that logic.
///     - 🥥 Use the pattern when your class has a massive
///     conditional operator that switches between different
